...
public:
	CHeightImage(LPCTSTR pFileName, int nWidth, int nLength, XMFLOAT3 xmf3Scale);
	~CHeightImage(void);
...
class CHeightMesh : public CTerrainMesh
{
protected:
	int m_nWidth;
	int m_nLength;
...
public:
	CHeightMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList
